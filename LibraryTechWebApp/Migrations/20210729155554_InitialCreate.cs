        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfRequestst = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReleasedPerLibraryTech = table.Column<DateTime>(type: "datetime2", nullable: false),
                    DateOfWriting = table.Column<DateTime>(type: "datetime2", nullable: false),
                    BookVolume = table.Column<int>(type: "int", nullable: false),
                    ...
                    IsAvailableBySubs = table.Column<bool>(type: "bit", nullable: false),
                    NumberOfRequestst = table.Column<long>(type: "bigint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppUserModelBook", x => new { x.BooksBookId, x.UserId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookBookAuthor", x => new { x.AuthorsId, x.BooksBookId });
                    table.ForeignKey(
                        name: "FK_BookBookAuthor_Authors_AuthorsId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FullReview = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookBookCategory", x => new { x.BooksBookId, x.CategoriesId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookBookCategory_Categories_CategoriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookBookSeries", x => new { x.BooksBookId, x.SeriesId });
                    table.ForeignKey(
                        name: "FK_BookBookSeries_Books_BooksBookId",
                        column: x => x.BooksBookId,
                        principalTable: "Books",
                        principalColumn: "BookId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookBookSeries_Series_SeriesId",
                        column: x => x.SeriesId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookCategoryBookSeries", x => new { x.CategoriesId, x.SeriesId });
                    table.ForeignKey(
                        name: "FK_BookCategoryBookSeries_Categories_CategoriesId",
                        column: x => x.CategoriesId,
                        principalTable: "Categories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookCategoryBookSeries_Series_SeriesId",
                        column: x => x.SeriesId,
                        principalTable: "Series",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCategoryBookSeries_SeriesId",
                table: "BookCategoryBookSeries",
                column: "SeriesId");
